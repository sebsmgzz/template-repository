<!-- 
Use this pull request template to request a hot fix integration into the existing main branch.
-->

Hot fix
=======

<!-- Provide the id of the bug solved. If none, provide a unique name for it. -->
| Issue id: # |
| :---------- |

### Previous behaviour
<!-- Briefly describe the behaviour before your changes. -->

### New behaviour
<!-- Briefly describe the behaviour with your changes. -->
